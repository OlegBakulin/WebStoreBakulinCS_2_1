...
using WebStoreCoreApplication.Domain.DTO.Identity;
using WebStoreCoreApplication.Domain.Entities.Identity;
using WebStoreBakulin.Interfaces.Services.Identity;

namespace WebStore.Clients.Identity
{
    public class UsersClient : BaseClient, IUsersClient
    {
        public UsersClient(IConfiguration Configuration) : base(Configuration, WebApiAdress.Identity.User) { }
        ...
        public async Task AddClaimsAsync(User user, IEnumerable<Claim> claims, CancellationToken cancel)
        {
            await PostAsync(
                ...
                new AddClaimDTO { User = user, Claim = claims },
                cancel);
        }
        ...
        public async Task RemoveClaimsAsync(User user, IEnumerable<Claim> claims, CancellationToken cancel)
        {
            await PostAsync(
                ...
                new RemoveClaimDTO { User = user, Claim = claims },
                cancel);
        }
